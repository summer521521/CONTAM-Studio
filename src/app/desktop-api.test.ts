...
import {
  ...
  startReadonlyAiTurn,
  generateGeometryDraftFromImage,
  ...
  it("invokes every registered command with the exact complete payload", async () => {
    ...
    const cases = [
      ...
      [
        ...
        loadProjectGeometryDocument("request-036", "session-001", "revision-001"),
        { requestId: "request-036", projectSessionId: "session-001", revisionId: "revision-001" },
      ],
      [
        ...
        saveProjectGeometryDocument(
          ...
          "session-001",
          "revision-001",
          { schema_version: "building_geometry.v1" } as never,
          null,
          3,
        ),
        {
          ...
          geometry: { schema_version: "building_geometry.v1" },
          semanticDraft: null,
      ...
      ["generate_geometry_draft_from_image", generateGeometryDraftFromImage(
        "request-035",
        "session-001",
        ...
        requestId: "request-035",
        projectSessionId: "session-001",
        revisionId: "11111111-1111-4111-8111-111111111111",
        attachmentId: "22222222-2222-4222-8222-222222222222",
        geometry: { schema_version: "building_geometry.v1" },
        prompt: "Trace visible walls",
        language: "zh-CN",
      }],
      [
        "preview_ai_context",
