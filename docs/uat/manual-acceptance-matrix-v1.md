...
| GUI-08 | 官方夹具副本与已连接AI | 切换“分析/仿真方案”，生成单Zone体积方案，确认Back/Cancel/Approve and Run、失败保留草稿与上一可信结果 | 无路径/PRJ正文泄漏；固定Patch→Run→Result→Analysis时间线；中英文、主题与键盘不退化 | pending_final_acceptance |
