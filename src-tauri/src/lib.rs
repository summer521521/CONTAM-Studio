...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            zone_bridge::prepare_study_plan,
            zone_bridge::run_study,
            zone_bridge::cancel_study,
            zone_bridge::page_study_results,
            zone_bridge::analyze_study_results,
            zone_bridge::export_study_report,
